...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference("Fornecedor.count") do
      post fornecedors_url, params: { fornecedor: { cnpj: @fornecedor.cnpj, contato_nome: @fornecedor.contato_nome, email: @fornecedor.email, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }, as: :json
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cnpj: @fornecedor.cnpj, contato_nome: @fornecedor.contato_nome, email: @fornecedor.email, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }, as: :json
    assert_response :success
  end
