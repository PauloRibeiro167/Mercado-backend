class Api::V1::CaixaReconciliacaosController < ApplicationController
  before_action :set_api_v1_caixa_reconciliacao, only: %i[ show update destroy ]

  # GET /api/v1/caixa_reconciliacaos
  def index
    @api_v1_caixa_reconciliacaos = Api::V1::CaixaReconciliacao.all
  ...
  def create
    @api_v1_caixa_reconciliacao = Api::V1::CaixaReconciliacao.new(api_v1_caixa_reconciliacao_params)
  ...
  private
    ...
    def set_api_v1_caixa_reconciliacao
      @api_v1_caixa_reconciliacao = Api::V1::CaixaReconciliacao.find(params.expect(:id))
    end
