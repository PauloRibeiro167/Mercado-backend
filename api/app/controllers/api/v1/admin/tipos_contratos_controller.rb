class Api::V1::Admin::TiposContratosController < ApplicationController
  ...
  # GET /tipos_contratos
  def index
    @tipos_contratos = Admin::TiposContrato.all
  ...
  def create
    @tipos_contrato = Admin::TiposContrato.new(tipos_contrato_params)
...
private
  ...
  def set_tipos_contrato
    @tipos_contrato = Admin::TiposContrato.find(params.require(:id))
  end
