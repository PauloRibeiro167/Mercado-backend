...
private
  ...
  def avisar_frontends
    ActionCable.server.broadcast("conta_pagars_channel", { acao: "atualizado", id: self.id })
  end

public include Discard::Model
  ...
  has_many :parcelas, class_name: "financeiro::ParcelaContaPagar", dependent: :destroy
