...
ActiveRecord::Schema[8.0].define(version: 2026_01_06_123721) do
  ...
  create_table "caixa_reconciliacoes", comment: "Registra auditorias e reconciliações de caixas fiscais", force: :cascade do |t|
    t.bigint "caixa_id", null: false, comment: "Caixa auditado"
    t.bigint "usuario_responsavel_id", null: false, comment: "Usuário que executou a reconciliação"
    t.bigint "sessao_caixa_id", null: false, comment: "Sessão do caixa referente à divergência"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["caixa_id", "realizada_em"], name: "index_reconciliacoes_on_caixa_and_realizada_em"
    t.index ["caixa_id"], name: "index_caixa_reconciliacoes_on_caixa_id"
    t.index ["realizada_em"], name: "index_caixa_reconciliacoes_on_realizada_em", comment: "Facilita consultas por período de reconciliação"
    t.index ["sessao_caixa_id"], name: "index_caixa_reconciliacoes_on_sessao_caixa_id"
    t.index ["status"], name: "index_caixa_reconciliacoes_on_status"
  ...
  create_table "caixas", comment: "Tabela para gerenciar caixas registradoras, incluindo saldo e status de operação", force: :cascade do |t|
    ...
    t.index ["status"], name: "index_caixas_on_status", comment: "Índice para filtrar por estado operacional"
    ...
    t.check_constraint "limite_alerta_maximo = 0::numeric OR limite_alerta_maximo >= limite_alerta_minimo", name: "limite_alerta_maximo_maior_ou_igual_minimo"
    t.check_constraint "limite_alerta_maximo >= 0::numeric", name: "limite_alerta_maximo_nao_negativo"
    t.check_constraint "limite_alerta_minimo >= 0::numeric", name: "limite_alerta_minimo_nao_negativo"
  ...
  create_table "parcela_conta_pagars", force: :cascade do |t|
    t.bigint "conta_pagar_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["conta_pagar_id"], name: "index_parcela_conta_pagars_on_conta_pagar_id"
  end
  ...
  create_table "sessao_caixas", comment: "Tabela para gerenciar sessões de caixas, incluindo abertura, fechamento e supervisão", force: :cascade do |t|
    t.bigint "usuario_id", null: false, comment: "Usuário associado à sessão"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["abertura"], name: "index_sessao_caixas_on_abertura"
    t.index ["caixa_id", "status"], name: "index_sessao_caixas_on_caixa_id_and_status"
    t.index ["caixa_id"], name: "index_sessao_caixas_on_caixa_id"
    t.index ["fechamento"], name: "index_sessao_caixas_on_fechamento"
    t.index ["gerente_supervisor_id"], name: "index_sessao_caixas_on_gerente_supervisor_id"
    t.index ["status"], name: "index_sessao_caixas_on_status"
  ...
  add_foreign_key "caixa_reconciliacoes", "caixas"
  add_foreign_key "caixa_reconciliacoes", "sessao_caixas"
  add_foreign_key "caixa_reconciliacoes", "usuarios", column: "usuario_responsavel_id"
  ...
  add_foreign_key "parcela_conta_pagars", "conta_pagars"
