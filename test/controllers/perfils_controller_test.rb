...
class PerfilsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perfil" do
    assert_difference("Perfil.count") do
      post perfils_url, params: { perfil: { descricao: @perfil.descricao, nome: @perfil.nome } }, as: :json
    end
  ...
  test "should update perfil" do
    patch perfil_url(@perfil), params: { perfil: { descricao: @perfil.descricao, nome: @perfil.nome } }, as: :json
    assert_response :success
  end
